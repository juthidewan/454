...
nyc_clean2 <- nyc_clean %>%
  ...
  mutate(transportation_desert_4cat = cut(perc_covered_by_transit, breaks=c(-1, 10, 60, 90, 100), 
...
model2 <- stan_polr(transportation_desert_4num ~ mean_income + below_poverty_perc + eviction_count + store_count, data =data_train, prior=NULL,iter=500, seed = 86437, refresh=0, prior_PD=FALSE)
