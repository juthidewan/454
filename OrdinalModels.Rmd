...
```{r}
model1 <- stan_polr(transportation_desert_4cat ~ unemployment_count + noncitizen_count + white_count, data =nyc_clean, prior=NULL,iter=5000, seed = 86437, refresh=0, prior_PD=FALSE)
```
