...
brown <- ggplot(census_nta) +
  geom_sf(aes(fill = uninsured_percent), color = "#8f98aa")+
  scale_fill_gradient(low = "#FCF5EE", high = "#F450E1", guide = guide_legend(title = "Percent of People without Insurance Coverage")) +
  theme_minimal() +
  theme(panel.grid.major = element_line("transparent"),
        axis.text = element_blank()) +
...
ggarrange(red, orange, yellow, yellow_green, green, teal, blue, purple, pink, brown, ncol=3)
```
