...
```{r}
setwd("/Users/freddy/Desktop/STAT 454/Transit/")
```
...
```{r}
grocery <- read_csv("/Users/freddy/Desktop/STAT 454/Transit/Data/grocery.csv")
schools <- read_csv("/Users/freddy/Desktop/STAT 454/Transit/Data/schools.csv")
green_space <- read_csv("/Users/freddy/Desktop/STAT 454/Transit/Data/parks.csv")
evictions <- read_csv("/Users/freddy/Desktop/STAT 454/Transit/Data/evictions.csv")
access_income <- read_csv("/Users/freddy/Desktop/STAT 454/Transit/Data/transit_income.csv")
demographics <- read_csv("/Users/freddy/Desktop/STAT 454/Transit/Data/demographics.csv")
rental_price <- read_csv("/Users/freddy/Desktop/STAT 454/Transit/Data/median_rent.csv")
```
...
# read shapefiles
boundary_nyc <- st_read("/Users/freddy/Desktop/STAT 454/Transit/Data/zip_code_boundaries/ZIP_CODE_040114.shp", quiet = TRUE)
```
